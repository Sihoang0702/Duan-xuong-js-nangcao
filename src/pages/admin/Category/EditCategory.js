      ...
      <div class="flex-auto pl-9 pb-2">
        <div class=" overflow-x-auto">
          <form id="update-form">
            ...
            <input type="text" id="name" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-2/5 appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow   " placeholder="Loại" value="${
              cate.name
            }"  />
            </div>

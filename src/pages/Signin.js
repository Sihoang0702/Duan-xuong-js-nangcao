        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0  ">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <button type="submit" class=" w-full rounded-lg px-5 py-2 text-white bg-orange-500     ">Đăng
                        kí</button>
                    <p class="text-sm font-light text-dark-500 dark:text-dark-400">
                        Bạn đã có tài khoản? <a href="#" class="font-medium text-blue-600 hover:underline ">Đăng
                            nhập</a>
                    </p>
